      ...
      <div className="App">
        ...
        <div className="container">
          ...
          {listNews2.map((item, key) => {
            return <BeritaTerkini key={key} title={item.title} url={item.url} publishedAt={item.publishedAt} author={item.author}/> 
          })}
          <br/>
          </div>
          ...
          <div class="col-md-8">
            ...
            {listNews.map((item,key) => {
              ...
              return <ContentBlog key={key} title={item.title} publishedAt={item.publishedAt} content={src_content} img={src_img} author={item.author}/>;
            })}
          </div>  
          </div>
        </div>
